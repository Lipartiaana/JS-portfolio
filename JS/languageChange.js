...
function updatePageContent(lang) {
  const content = {
    ...
    ka: {
      ...
      <p> სწავლა <span>'Bitcamp'</span>- ის Front-end დეველოპმენტის უფასო ეტაპებით დავიწე, რამაც ძალიან გამიტაცა, ამის შემდეგ დავიწყე Youtube-იდან და Udemy -დან სწავლა დამოუკიდებლად.</p>
